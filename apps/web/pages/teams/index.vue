      ...
      <div v-for="team in teams" :key="team.id"
        ...
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex flex-col items-end gap-1">
            ...
            <span v-if="team.recruitment_open" class="px-2 py-0.5 rounded text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300">
              Rekrutacja otwarta
            </span>
          </div>
        </div>
...
=======
          ...
          <div class="flex gap-2 justify-end">
            <button type="button" @click="showCreateModal = false" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">Anuluj</button>
            <button type="submit" class="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">Utwórz drużynę</button>
>>>>>>> Stashed changes
          </div>
        </form>
      </div>
